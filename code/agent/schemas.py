...
CRITIQUE_SCHEMA = {
    ...
    "properties": {
        ...
        }, "required": ["evidence_id", "effect", "related_event_id", "amount", "currency", "effective_date", "status", "category", "direction", "description", "recurring", "recurrence_days", "flexibility", "minimum_allowed_amount", "stream_key"], "additionalProperties": False},
        "summary": {"type": "string"},
    },
