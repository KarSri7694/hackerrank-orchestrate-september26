...
FACT_SCHEMA = {
    ...
    "properties": {"facts": {"type": "array", "items": {
        ...
        "properties": {
            "effect": {"type": "string"}, "related_event_id": {"type": ["string", "null"]},
        ...
        "required": ["effect", "related_event_id", "amount", "currency", "effective_date", "status", "category", "direction", "description", "recurring", "recurrence_days", "confidence"],
    }}},
...
class OpenAIEvidenceExtractor:
    ...
    def extract(self, reference):
        content = [{"type": "input_text", "text": (
            ...
            "Use related_event_id when supplied; otherwise return a stream-level category/direction/effective date. "
